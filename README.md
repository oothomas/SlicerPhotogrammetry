...
Due to these complexities of installing Docker, Photogrammetry extension is not provided as part of the Slicer Extension Catalogue for MacOS and Windows, only Linux is supported. But if you are an advanced user and successfully installed docker on your computer, you can manually install the Photogrammetry extension by:
